...
/*globals define: false */ (function(window) {
...
(function(window) {
    ...
    if (typeof define === 'function' && define.amd) {
        // AMD
        define(['eventEmitter/EventEmitter', 'get-size/get-size', 'get-style-property/get-style-property'],
...
(function(window) {
    ...
    if (typeof define === 'function' && define.amd) {
        // AMD
        define(['eventie/eventie', 'doc-ready/doc-ready', 'eventEmitter/EventEmitter', 'get-size/get-size', 'matches-selector/matches-selector', './item'],
        outlayerDefinition);
    } else {
        // browser global
...
(function(window) {
    ...
    function masonryDefinition(Outlayer, getSize) {
        ...
        Masonry.prototype.measureColumns = function() {
            ...
            if (!this.columnWidth) {
                ...
                this.columnWidth = firstItemElem ? getSize(firstItemElem)
                    .outerWidth :
            ...
            this._containerWidth = getSize(container)
                .innerWidth;
    ...
    if (typeof define === 'function' && define.amd) {
        // AMD
        define(['outlayer/outlayer', 'get-size/get-size'],
        masonryDefinition);
    } else {
        // browser global
